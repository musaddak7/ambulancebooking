...
--
-- Table structure for table `addhospitals`
--

CREATE TABLE `addhospitals` (
  `id` int(50) NOT NULL,
...
--
-- Dumping data for table `addhospitals`
--

INSERT INTO `addhospitals` (`id`, `hospitalid`, `userid`) VALUES
(2, 1, 17),
(11, 2, 17),
(12, 1, 17),
(13, 1, 17),
...
--
-- Table structure for table `cablists`
--

CREATE TABLE `cablists` (
  `id` int(30) NOT NULL,
...
--
-- Dumping data for table `cablists`
--

INSERT INTO `cablists` (`id`, `reg_code`, `category_id`, `cab_reg_no`, `body_no`, `cab_model`, `cab_driver`, `driver_contact`, `driver_address`, `password`, `image_path`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
INSERT INTO `categorylists` (`id`, `name`, `ambocat`, `description`, `delete_flag`, `status`, `date_created`, `date_updated`) VALUES
(1, '5 Seater', 'Basic Life Support', 'A 4-door passenger car with a trunk that is separate from the passengers with a three-box body: the engine, the area for passengers, and the trunk.', 0, 1, '2022-03-01 10:03:54', '2023-06-11 20:31:24'),
(2, '6 Seater', 'Speciality Care Support', 'Quisque iaculis ipsum egestas nisi pharetra, ac laoreet felis tincidunt. Cras id gravida justo. Nulla non gravida risus, vel finibus leo. Phasellus vel eros ligula. Fusce a erat sed quam vehicula convallis.', 0, 1, '2022-03-01 10:08:10', '2023-06-11 20:32:56'),
(3, '7 Seater', 'Advance Life Support', 'Flexible, allowing you to switch between lots of seats or lots of boot space. The biggest manage to do both - comfortably taking six passengers and their stuff.', 0, 1, '2022-03-03 12:59:29', '2023-06-11 20:32:13');
...
--
-- Table structure for table `hospitallists`
--

CREATE TABLE `hospitallists` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `hospitallists`
--

INSERT INTO `hospitallists` (`id`, `name`, `contact`, `location`) VALUES
(1, 'Ahsania mission', '01772829800', 'uttara'),
(2, 'Bangladesh', '0177****', 'house building');
...
(1, 'Adminstrator', 'Liam', 'm5', 'd00f5d5217896fb7fd601412cb890830'),
(17, '1', '1', '1', '$2y$10$k2dvT8NRvI3j7pHYZXbWcew6nUyQ2uE46m8L7.k7lQ4nsXo36D1k6'),
(23, 'ma', 'monjil', 'ma1', '$2y$10$FqMPVb4/GWCAZc8GtPINJeUynSyuOfCA0dv8cwPIIOsJJL/p5dm1K'),
(24, 'i', 'i', 'i', '$2y$10$USUVZ6KAOOI5poyTDZE6Ve6YmfW.gmsy8zk91/zCqJ52I4Do9qijK'),
(25, 'i', 'i', 'i', '$2y$10$PXOvaTkQRzE5pnSWPx0BaeQ0.y4xerFxEu35f1zVzTEVUl2nZrn4.'),
(26, 'k', 'k', 'k', '$2y$10$N/B4dZiyZSDIJEOduGh8KebAwRRCN29ntBvxY/i6xmCDDaqCaUAyK'),
(27, 'g', 'g', 'g', '$2y$10$KTIz7Bj1rSjQNxBhk4mOEOozjrl6fTeyn/crAkBfd7PBRDYwZ3kKC'),
(28, 'j', 'j', 'jj', '$2y$10$CLvNk44.kkW0R6aqR/mQFO7tttXugL15EvsaULCSst2zqcbw5bHwO'),
(29, 'j', 'j', 'j', '$2y$10$5xZSdqjeYFmv32aogVV8yeGn1vLD/LvQY5NmRawEeqYRhO9bjIEXe'),
(30, 'l', 'l', 'l', '$2y$10$aAV9g3CX0yV6x8FR8qBOfuVv9PXDP22EW5o3CZmGOZSy4ik28AEEO'),
(31, 'f', 'f', 'f', '$2y$10$Uia3NRCKLcf8H/fqLk.yNOtKdwMbuZ0REywxEEN4anrUTg9yBvWS2');
...
--
-- Indexes for table `addhospitals`
--
ALTER TABLE `addhospitals`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cablists`
--
ALTER TABLE `cablists`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `hospitallists`
--
ALTER TABLE `hospitallists`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `addhospitals`
--
ALTER TABLE `addhospitals`
...
--
-- AUTO_INCREMENT for table `cablists`
--
ALTER TABLE `cablists`
...
--
-- AUTO_INCREMENT for table `hospitallists`
--
ALTER TABLE `hospitallists`
...
--
ALTER TABLE `booking_list`
  ADD CONSTRAINT `booking_list_ibfk_1` FOREIGN KEY (`cab_id`) REFERENCES `cablists` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `booking_list_ibfk_2` FOREIGN KEY (`client_id`) REFERENCES `client_list` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `cablists`
--
ALTER TABLE `cablists`
  ADD CONSTRAINT `cablists_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categorylists` (`id`) ON DELETE CASCADE;
COMMIT;
