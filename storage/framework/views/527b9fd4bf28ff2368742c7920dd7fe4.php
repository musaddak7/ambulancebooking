  ...
  <div class="" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="userlogin">Hospitalbooking<span class="">(<?php echo e($total); ?>)</span></a>
      </li>

      <?php if(Session::has('user')): ?>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href=""><?php echo e(Session::get('user')['username']); ?></a>
...
</nav><?php /**PATH C:\Users\Musaddak Rana\OneDrive\Desktop\ambulancebooking\resources\views/header.blade.php ENDPATH**/ ?>